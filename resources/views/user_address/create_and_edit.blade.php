            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form class="form-horizontal" role="form" method="post" action="{{ route('user_address.update', ['user_address' => $address->id]) }}">
                                {{ method_field('PUT') }}
                        @else
                        ...
                        @endif
                            ...
                            <div class="form-group row text-center">
                                <div class="col-12">
                                    ...
                                    <a class="btn btn-light" href="{{ route('user_address.index') }}">取消</a>
                                </div>
                            </div>
                        </form>
