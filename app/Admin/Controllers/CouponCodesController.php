...
//            return $this->type === CouponCode::TYPE_FIXED ? '￥' : $value . '%';
//        });
...
//        $form->text('code', '优惠码')->rules('nullable|unique:coupon_codes'); // 当编辑时此规则不适用，应改为如下
        ...
        $form->radio('type', '类型')->options(CouponCode::$typeMap)
                                                 ->rules('required')
